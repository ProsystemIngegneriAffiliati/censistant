...
public class JobOrderLazyDataModel extends LazyDataModel<JobOrder>{
    ...
    public List<JobOrder> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        List<JobOrder> result = service.listJobOrders(first, pageSize, sortField, isAscending, number, customerName, plantAddress, description, systemType);
        this.setRowCount(service.getJobOrdersCount(number, customerName, plantAddress, description, systemType).intValue());
