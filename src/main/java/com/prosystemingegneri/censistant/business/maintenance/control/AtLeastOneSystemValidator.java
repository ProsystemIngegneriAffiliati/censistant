 ...
 */
public class AtLeastOneSystemValidator implements ConstraintValidator<AtLeastOneSystem, MaintenanceContract> {

    @Override
    public void initialize(AtLeastOneSystem constraintAnnotation) {
    }
