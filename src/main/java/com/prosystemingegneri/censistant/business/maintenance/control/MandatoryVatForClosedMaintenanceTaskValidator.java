 ...
 */
public class MandatoryVatForClosedMaintenanceTaskValidator implements ConstraintValidator<MandatoryVatForClosedMaintenanceTask, MaintenanceTask> {

    @Override
    public void initialize(MandatoryVatForClosedMaintenanceTask constraintAnnotation) {
    }
