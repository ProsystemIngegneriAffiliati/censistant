 ...
 */
public class MandatoryInspectionsDoneForClosedMaintenanceTaskValidator implements ConstraintValidator<MandatoryInspectionsDoneForClosedMaintenanceTask, MaintenanceTask> {

    @Override
    public void initialize(MandatoryInspectionsDoneForClosedMaintenanceTask constraintAnnotation) {
    }
