 ...
 */
public class MandatorySuitableForOperationForClosedMaintenanceTaskValidator implements ConstraintValidator<MandatorySuitableForOperationForClosedMaintenanceTask, MaintenanceTask> {

    @Override
    public void initialize(MandatorySuitableForOperationForClosedMaintenanceTask constraintAnnotation) {
    }
